...
const BASE_PATH = '/api/stat/totalword';

const TotalWordService = function (app) {
    /**
     * 管理员字数列表接口
     */
    app.post(`${BASE_PATH}/list`, (request, response) => {
        let { start, end } = Utils.handlePageParams(request.body);
        let $sql = 'SELECT date,type,info FROM stat_total_word WHERE 1=1 ';
        let params = [];
...
module.exports = TotalWordService;
